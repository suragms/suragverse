...
function Chapter({
  ...
  return (
    <div
      ref={ref}
      className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center py-20 sm:py-28"
    >
      {/* Image */}
      ...
      <div className={reversed ? "lg:order-1" : ""}>
        ...
        >
          ...
          <h3 className="font-[family-name:var(--font-heading)] text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-[0.95] mt-4 mb-6">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16 text-center">
          ...
          <motion.h2
            ...
            className="font-[family-name:var(--font-heading)] text-4xl sm:text-6xl md:text-7xl font-bold tracking-tight leading-[0.95]"
          >
            HOW IT
            <br />
